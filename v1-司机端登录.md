...
```
## 请求流程(方便排查错误)
请求到达 → TokenAuthenticationFilter → JwtTokenProvider验证 → 封装到SecurityContext → 后续处理

微信小程序 → API网关 → Web层(DriverController) → Feign客户端 → Service层(Driver服务) → 数据库
...
问题: 请求被拒绝,WebSecurityConfig出问题,没有正确放行请求,并路由到 web-driver 模块的 controller 控制器
```text
...
## 错误2: service-security
```text
2026-02-02T18:46:47.779+08:00 ERROR 13600 --- [web-driver] [  restartedMain] o.s.b.web.embedded.tomcat.TomcatStarter  : Error starting Tomcat context. Exception: org.springframework.beans.factory.UnsatisfiedDependencyException. Message: Error creating bean with name 'tokenAuthenticationFilter' defined in file [E:\codebase\leshang-daijia-20260104\common\service-security\target\classes\com\daijia\security\filter\TokenAuthenticationFilter.class]: Unsatisfied dependency expressed through constructor parameter 0: Error creating bean with name 'tokenService' defined in file [E:\codebase\leshang-daijia-20260104\common\service-security\target\classes\com\daijia\security\service\TokenService.class]: Unsatisfied dependency expressed through constructor parameter 2: Error creating bean with name 'driverInfoMapper' defined in file [E:\codebase\leshang-daijia-20260104\service\service-driver\target\classes\com\daijia\mapper\DriverInfoMapper.class]: Property 'sqlSessionFactory' or 'sqlSessionTemplate' are required
