...
import com.daijia.service.CiService;
...
public class CosServiceImpl implements CosService {
     ...
     * 示例：/driver/auth/0o98754.jpg
     *
     * 2. 图片审核功能
     * 上传后自动调用图片内容审核服务(ciService.imageAuditing())
     * 如果图片审核不通过：
     * 自动删除已上传的违规图片
     * 抛出异常IMAGE_AUDITION_FAIL
     */
    @Override
    ...
    /**
     * 3. 临时访问URL生成 (getImageUrl方法)
     * 为私有存储的文件生成15分钟有效期的临时访问链接
     * 用于前端预览/回显图片
     */
    @Override
